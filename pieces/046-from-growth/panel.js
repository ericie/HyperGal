// The control panel. On fxhash these parameters were set in the minting
...
(() => {
  ...
  function reform() {
    // The page supplies this: it re-derives the parameters and rebuilds the
    // piece from them. Falls back to applyParams() alone where that is enough.
    if (typeof window.reformPiece === 'function') { window.reformPiece(); return; }
