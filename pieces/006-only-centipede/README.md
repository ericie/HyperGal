...
shoot straight, and each can only keep one bullet in the air. Mushrooms block
bullets and steer the centipedes; each mushroom visibly dents, leans, and
deforms across three bullet hits before clearing.
...
centipede's color, and new split-off centipedes take on fresh colors. When one
live centipede hits another, the struck section behaves like it was shot.
