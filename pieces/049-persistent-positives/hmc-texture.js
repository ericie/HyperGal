...
TextureObject.prototype.createCanvas = function(e) {
  let t = document.getElementById("library"),
    ...
    a = r.getContext("2d"),
    n = "texture_1";
  r.setAttribute("id", n), r.setAttribute("height", stage.w / 8), r.setAttribute("width", stage.h / 8), t.appendChild(r), this.layerObj = {
    id: n,
    elem: r,
    canvas: a
  }
  ...
  for (; t < stage.h;) {
    for (; e < stage.w;) r.fillStyle = "rgba(0,0,0,.4)", r.beginPath(), r.arc(e, t, 5, 0, 2 * Math.PI, !1), r.closePath(), r.fill(), e += 20;
    t += 20, e = 0
  }
