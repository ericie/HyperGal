...
`Marbles`, but compresses them into a near-black oil field. Ten sideways,
...
and a replacement grows over a different untouched deposit. A bubble that
reaches zero also pops. Its replacement starts just outside one of the four
edges with a partial tank.
