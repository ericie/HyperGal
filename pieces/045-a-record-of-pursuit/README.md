...
Sixteen targets sit on a four-by-four grid. Thirty-two lines chase them — some
orbiting, some spiralling in and out, some wandering — and every so often a line
gives up on its target and sets off after the next one. What you see is not the
...
it sits behind the picture under a twenty-pixel blur, so those lines exist only
as light. Half the chase is legible and half of it is atmosphere.
